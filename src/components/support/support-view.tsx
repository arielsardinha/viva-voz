...
import { PixIcon } from "@/components/pdf-reader/support-dialog";
...
export function SupportView() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        className="w-full glass-panel border border-border/80 rounded-3xl p-5 sm:p-7 shadow-xl space-y-5 flex flex-col"
      >
